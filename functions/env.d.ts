export interface Env {
  ...
  /**
   * File Google Sheet chứa tab BAN_DAO + THU_CHI + COC + CONG_NO (một file — bật khi set biến này).
   * Nếu không set: web/bot dùng layout cũ — THU_CHI & COC trên MAIN, CONG_NO & BAN_DAO trên SPREADSHEET_ID_DEBT_SALES.
   */
