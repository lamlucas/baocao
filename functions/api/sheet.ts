...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  /** Số thực (không stringify) để Sheets không ép A2:D2 sang định dạng văn bản — tránh lỗi công thức tham chiếu (vd. E2). */
  const a2Num = num(body.tongQuan?.a2 != null ? String(body.tongQuan.a2) : "0");
  ...
  const tqRows: (string | number)[][] = [
    ["Dư đầu", "Tổng cọc", "Nhận cọc", "Tổng công nợ"],
    [a2Num, sumCocC, sumCocB, sumCongNoB],
  ];
