...
function renderChiTieuLinesTable(tbodyEl, rows) {
  ...
  for (const r of rows) {
    ...
    tr.innerHTML = `
      ...
      <td class="cell-readonly cell-num">${fmtChiTieuUsd(parseNumClient(r.tongTieu))}</td>
      <td class="cell-readonly cell-num">${fmtChiTieuUsd(parseNumClient(r.tongThu))}</td>
      ...
      if (latestMonth) {
        for (const n of chiTieuByNguonForMonth(entries, latestMonth)) {
          ...
          tr.innerHTML = `
            ...
            <td class="cell-num">${fmtChiTieuUsd(n.tongTieu)}</td>
            <td class="cell-num">${fmtChiTieuUsd(n.tongThu)}</td>`;
